...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->rezultBtn->Text = L"–ÂÁÛÎ¸Ú‡ÚË";
			...
			this->ÒÚ‚ÓËÚËToolStripMenuItem->Size = System::Drawing::Size(126, 22);
			...
			this->‚≥‰ÍËÚËToolStripMenuItem->Size = System::Drawing::Size(126, 22);
			...
			this->ÔÓœÓ„‡ÏÛToolStripMenuItem->Click += gcnew System::EventHandler(this, &EditTestForm::ÔÓœÓ„‡ÏÛToolStripMenuItem_Click);
			// 
			// groupBox1
			// 
			...
			this->navigateList->Items->AddRange(gcnew cli::array< System::Object^  >(1) {L"œËÚ‡ÌÌˇ π1"});
			...
			this->groupBox8->Text = L"¿‚ÚÓ ÚÂÒÚÛ";
			// 
			// author
			// 
			...
			this->groupBox7->Text = L"œ‡‚ÂÎ¸Ì‡ ‚≥‰ÔÓ‚≥‰¸";
			// 
			// correctAnswerBox
			// 
			...
			this->groupBox6->Text = L"◊‡Ò Ì‡ ‚ËÍÓÌ‡ÌÌˇ ÚÂÒÚÛ (ı‚ËÎËÌ)";
			// 
			// timeBox
			// 
			...
			this->groupBox5->Text = L" ≥Î¸Í≥ÒÚ¸ ‚≥‰ÔÓ‚≥‰ÂÈ";
			// 
			// countAnswerBox
			// 
			...
			this->groupBox9->Text = L" ≥Î¸Í≥ÒÚ¸ ·‡Î≥‚ Á‡ Ô‡‚ÂÎ¸ÌÛ ‚≥‰ÔÓ‚≥‰¸";
			// 
			// textBox1
			// 
...
private: System::Void addBtn_Click(System::Object^  sender, System::EventArgs^  e) {
			 //add new question
			 this->navigateList->Items->Add("œËÚ‡ÌÌˇ π" + countQuestion++);
		 }
