...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->tabPage1->Text = L"Параметри тесту";
			// 
			// applyBtn
			// 
			...
			this->label3->Text = L"Автор тесту";
			// 
			// textBox1
			// 
			...
			this->textBox1->Text = L"Немає автора";
			// 
			// label2
			// 
			...
			this->label2->Text = L"Кількість балів за правельну відповідь";
			// 
			// label1
			// 
			...
			this->label1->Text = L"Час на виконання тесту";
			// 
			// timeBox
			// 
			...
			this->tabPage2->Text = L"Зміна пароля";
			// 
			// saveBtn
			// 
